(function () {
     ...
     *
     * @function [自定义代码外页相关指令js] [definecode management outside page related instructions js]
     * @version  3.0.2
     */
    angular.module('danlan')
        .config(['$stateProvider', 'RouteHelpersProvider', function ($stateProvider, helper) {
            $stateProvider
                .state('home.customcode', {
                    url: '/customcode',
                    template: '<div class="home-content home-content-definecode">' +
                        '    <div class="home-div">' +
                        '        <div class="home-content-definecode-content" ui-view></div>' +
                        '    </div>' +
                        '</div>',
