(function () {
     ...
     *
     * @function [使用说明外页相关指令js] [Account management outside page related instructions js]
     * @version  3.0.2
     */
    angular.module('danlan')
        .config(['$stateProvider', 'RouteHelpersProvider', function ($stateProvider, helper) {
            $stateProvider
                .state('home.note', {
                    url: '/note',
                    template: '<div class="home-content home-content-note">' +
                        '    <div class="home-div">' +
                        '        <div class="home-content-note-content" ui-view></div>' +
                        '    </div>' +
                        '</div>'
                });
        }])
