(function () {
    ...
    homeProjectInsideDocEditController.$inject = ['$cookies', '$scope', 'ApiManagementResource', '$state', 'CODE', '$rootScope', 'GroupService', '$filter', 'HTML_LAZYLOAD'];

    function homeProjectInsideDocEditController($cookies, $scope, ApiManagementResource, $state, CODE, $rootScope, GroupService, $filter, HTML_LAZYLOAD) {
        var vm = this;
        ...
        vm.data.assistantFun.edit = function (arg) {
            ...
            arg.request.userID = $cookies.get('id');
