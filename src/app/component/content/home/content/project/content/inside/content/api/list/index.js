(function () {
    ...
    homeProjectInsideApiListController.$inject = ['$cookies', '$scope', '$rootScope', 'ApiManagementResource', '$state', 'GroupService', 'HomeProject_Common_Service', '$filter', 'CODE'];

    function homeProjectInsideApiListController($cookies, $scope, $rootScope, ApiManagementResource, $state, GroupService, HomeProject_Common_Service, $filter, CODE) {
        var vm = this;
        vm.data = {
            service: {
