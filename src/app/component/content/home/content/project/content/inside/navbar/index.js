            ...
            info: {
                menu: [{
                    ...
                    },
                    {
                        ...
                        //     {
                        //         name: '定时测试任务',
                        //         sref: 'home.project.inside.test.crontab.default',
                        //         childSref: 'home.project.inside.test.crontab',
                        //         params: {
                        //             groupID: null
                        //         }
                        //     }
                    ...
                    },
                    {
                        base: '/crontab',
                        name: '定时任务',
                        sref: 'home.project.inside.crontab',
                        childSref: 'home.project.inside.crontab.list',
                        icon: 'icon-naozhong',
                        power: -1
                    },
