            ...
            template.promise.then(function(response) {
                switch (response.statusCode) {
                    case CODE.COMMON.SUCCESS:
                        {
                            vm.data.service.home.envObject.object.model = angular.fromJson(response.apiInfo);
                            ...
                            switch (vm.data.service.home.envObject.object.model.baseInfo.apiProtocol) {    
                                case 0:
                            ...
                            switch (vm.data.service.home.envObject.object.model.baseInfo.apiStatus) {
                                case 0:
