            ...
            info: {
                ...
                menu: [{
                    ...
                    },
                    {
                        ...
                        sref: 'home.note',
                        icon: 'icon-xinwen',
                        childSref: 'home.note.basic',
                        isShow: -1
                    },
                    {
                        name: '通用函数',
                        sref: 'home.customcode',
                        icon: 'icon-ziliaoku',
                        childSref: 'home.customcode.list',
                        isShow: -1
                    },
                    // {
                    //     name: $filter('translate')('2101'),
                    //     href: 'https://www.danlan.com/#/',
                    //     icon: 'icon-ONLINEkaifa',
                    //     isShow: -1,
                    //     divide: 1
                    // }, {
                    //     name: '帮助中心',
                    //     href: 'http://help.danlan.com',
                    //     icon: 'icon-bangzhu',
                    //     isShow: -1,
                    // }
                ]
        ...
        vm.data.fun.menu = function (arg) {
            ...
            if (arg.item.childSref) {
                if (arg.item.otherChildSref && template.storage.companyHashKey) {
                    $state.go(arg.item.otherChildSref, {
                        companyHashKey: template.storage.companyHashKey
                    });
                } else {
