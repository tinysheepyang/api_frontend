(function () {
     ...
     */
    angular.module('danlan.modal', ['ui.bootstrap.modal'])
    ...
    function eoModalController($scope, $uibModal, $rootScope) {
        ...
        $rootScope.CrontabResumeModal = function openModel(title, necessity, info, btn, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'CrontabResumeModal',
                controller: 'CrontabResumeModalCtrl',
                resolve: {
                    title: function () {
                        return title;
                    },
        ...
        $rootScope.CrontabPauseModal = function openModel(title, necessity, info, btn, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'CrontabPauseModal',
                controller: 'CrontabPauseModalCtrl',
                resolve: {
                    title: function () {
                        return title;
                    },
        ...
        $rootScope.CrontabExecuteModal = function openModel(title, necessity, info, btn, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'CrontabExecuteModal',
                controller: 'CrontabExecuteModalCtrl',
                resolve: {
                    title: function () {
                        return title;
                    },
        ...
        $rootScope.CommonCrontabInputModal = function openModel(title, desc, info, input, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'CommonCrontabInputModal',
                controller: 'CommonCrontabInputModalCtrl',
                resolve: {
                    title: function () {
                        return title;
                    },
        ...
        $rootScope.ApiManagement_AutomatedTestCase_QiuckAddTestCaseModal = function openModel(input, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'ApiManagement_AutomatedTestCase_QiuckAddTestCaseModal',
                controller: 'ApiManagement_AutomatedTestCase_QiuckAddTestCaseModalCtrl',
                resolve: {
                    input: function () {
                        return input;
                    }
        ...
        $rootScope.ApiManagement_AutomatedCrontab_RelevanceTestCaseModal = function openModel(input, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'ApiManagement_AutomatedCrontab_RelevanceTestCaseModal',
                controller: 'ApiManagement_AutomatedCrontab_RelevanceTestCaseModalCtrl',
                resolve: {
                    input: function () {
                        return input;
                    }
