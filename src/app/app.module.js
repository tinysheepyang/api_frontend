(function () {
    ...
    function AppConfig($controllerProvider, $compileProvider, $filterProvider, $provide, $logProvider, $stateProvider, $urlRouterProvider, $locationProvider, $httpProvider, $translateProvider, IsDebug, CN) {
        ...
        data.fun.init = (function () {
            ...
            $httpProvider.defaults.transformRequest = [function (callback) {
                return angular.isObject(callback) && String(callback) !== '[object File]' ? data.fun.param({
                    object: callback
                }) : callback;
            }];
            // Enable log
    ...
    AppRun.$inject = ['$rootScope', '$state', '$stateParams', '$translate', '$templateCache', '$cookies'];


    function AppRun($rootScope, $state, $stateParams, $translate, $templateCache, $cookies) {
