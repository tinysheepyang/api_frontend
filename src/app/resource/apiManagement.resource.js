(function () {
    ...
    function ApiManagementResource($resource, serverUrl) {
        ...
        data.info.api['Crontab'] = $resource(serverUrl + 'Crontab/:operate', {
                ...
                Download: {
                    params: {
                        operate: 'downloadReport'
                    },
                    method: data.info.method
                },
                DeleteHistory: {
                    params: {
                        operate: 'deleteHistory'
                    },
                    method: data.info.method
                }
        ...
        data.info.api['CrontabGroup'] = $resource(serverUrl + 'CrontabGroup/:operate', {
