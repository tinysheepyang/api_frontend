(function () {
    ...
    angular
        ...
        .constant('CODE', {
            ...
            CRONTAB_API: {
                ERROR: '190000', //操作失败/列表为空等 The operation failed / list is null
                ILLEGAL_ID: '190001', //taskID格式非法 API ID format illegal 
                EXIST: '190002', //已存在相同定时任务 The same interface already exists
                ILLEGAL_SEARCH: '190003', //搜索关键字格式非法 Search keyword format illegal
                ILLEGAL_HISTORY_ID: '190004' //定时任务历史记录ID格式非法 API history ID format illegal
            },
            STATUS_CODE: {
            ...
            DEFINE_CODE: {
                ERROR: '410000', //查询自定义方法失败
                ILLEGAL_ID: '410001', //自定义函数id非法
                EMPTY: '410002' //自定义方法为空
            },
            EMPTY: '150008'
        })
})();