(function () {
    ...
    angular.module('danlan.directive').directive('copyDirective', ['$rootScope', '$compile', '$filter', function ($rootScope, $compile, $filter) {
        return {
            restrict: 'A',
            transclude: true,
            scope: {
            ...
            link: function ($scope, elem, attrs, ngModel) {
                ...
                $scope.data = {
                    ...
                    $scope.data.info.clipboard.fun.on('success', function (_default) {
                        ...
                        if (attrs.isPopup) {
                            //成功或者失败是否以弹窗形式提醒 Does the success or failure remind in popups
