(function () {
    ...
    angular.module('danlan.directive').directive("wangEditor", editorFn);
    ...
    function editorFn($timeout, $filter) {
        ...
        return {
            ...
            link: function ($scope, element, attrs, ngModel) {
                ...
                editor.config.menus = ['source', '|', 'bold', 'underline', 'italic', 'strikethrough', 'eraser',
                //'forecolor',
                //'bgcolor',
                '|', 'quote',
                //'fontfamily',
                'fontsize', 'head', 'unorderlist', 'orderlist', 'alignleft', 'aligncenter', 'alignright', '|', 'link', 'unlink', 'table', '|',
                // 'img',
