(function () {
    ...
    angular.module('danlan.directive').directive('checkPlugDirective', ['$compile', function ($compile) {
        return {
            restrict: 'AE',
            scope: {
                input: '='
            ...
            link: function ($scope, elem, attrs, ctrl) {
                ...
                data.fun.init = function () {
                    if (navigator.mimeTypes['application/danlan'] || window.plug && window.plug.type == "application/danlan") {
