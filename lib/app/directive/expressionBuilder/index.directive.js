(function () {
    ...
    angular.module('danlan.directive').directive('expressionBuilderDirective', ['$compile', '$filter', 'EXPRESSION_BUILDER_CONSTANT', function ($compile, $filter, EXPRESSION_BUILDER_CONSTANT) {
        return {
            restrict: 'AE',
            transclude: true,
