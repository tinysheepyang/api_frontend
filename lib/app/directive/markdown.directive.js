(function () {
    ...
    angular.module('danlan.directive').directive("markdown", editorFn);
                    ...
                    if (editor == null) {
                        editor = editormd(textarea, {
                            ...
                            toolbarIcons: function () {
                                //设置markdown导航栏标签功能 Set the markdown navigation bar tag function
                                // Or return editormd.toolbarModes[name]; // full, simple, mini
                                // Using "||" set icons align right.
                                return ["undo", "redo", "|", "bold", "del", "italic", "quote", "|", "h1", "h2", "h3", "h4", "h5", "h6", "|", "list-ul", "list-ol", "|", "link", "code", "table", "|", "watch"];
                            },
                            ...
                            imageUploadURL: "",
                            onload: function () {
                                //markdown初始化加载重置内容 markdown initializes the load to reset the content
                                try {
                            ...
                            onchange: function () {
                                //markdown内容改变执行函数 markdown contents change execution function
