(function () {
    ...
    angular.module('danlan.directive').directive('tipDirective', ['$filter', '$timeout', function ($filter, $timeout) {
        return {
            restrict: 'AE',
            transclude: true,
            template: '<span class="iconfont icon-yiwen1" ></span>' + '<div class="tips-message" style="margin-left: {{data.input.marginLeft}}px;margin-top:-{{data.element.clientHeight+5}}px"><ul><li class="message-li" id="tip-directive-js-{{data.info.uuid}}" ></li><li class="arrow-li"></li></ul></div>',
            scope: {
                input: '@'
            },
