(function () {
    ...
    angular.module('danlan.directive').directive('testDirective', ['$window', '$filter', '$timeout', '$rootScope', 'ApiManagementResource', 'CODE', function ($window, $filter, $timeout, $rootScope, ApiManagementResource, CODE) {
        return {
            restrict: 'A',
            transclude: true,
            replace: true,
            ...
            link: function ($scope, elem, attrs, ctrl) {
                ...
                $scope.test = function () {
                    ...
                    if (!$scope.send.disable) {
                        if ($window.plug && $window.plug.type == "application/danlan") {
