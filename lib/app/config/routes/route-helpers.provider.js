(function () {
    ...
    angular.module('danlan').provider('RouteHelpers', RouteHelpersProvider);
            ...
            return {
                deps: ['$ocLazyLoad', '$q', function ($ocLL, $q) {
                    ...
                    function andThen(_arg) {
                        ...
                        if (typeof _arg === 'function') return promise.then(_arg);else return promise.then(function () {
                    ...
                    function getRequired(name) {
                        if (data.info.query.MODULES) for (var m in data.info.query.MODULES) if (data.info.query.MODULES[m].name && data.info.query.MODULES[m].name === name) return data.info.query.MODULES[m];
