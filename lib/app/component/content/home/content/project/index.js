(function () {
    ...
    angular.module('danlan').config(['$stateProvider', 'RouteHelpersProvider', function ($stateProvider, helper) {
        $stateProvider.state('home.project', {
            url: '/project',
            template: '<div class="home-content home-content-project">' + '    <div class="home-div">' + '        <div class="home-content-project-content" ui-view></div>' + '    </div>' + '</div>'
        });
    }]);
})();