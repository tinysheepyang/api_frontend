(function () {
    ...
    angular.module('danlan').config(['$stateProvider', 'RouteHelpersProvider', function ($stateProvider, helper) {
        $stateProvider.state('home.project.inside.api.list', {
    ...
    function homeProjectInsideApiListController($scope, $rootScope, ApiManagementResource, $state, GroupService, HomeProject_Common_Service, $filter, CODE) {
        ...
        vm.data.fun.storage = function (arg) {
            ...
            switch (arg.item.starred - 0) {
                case 0:
                    {
                        ApiManagementResource.Star.Add(template.request).$promise.then(function (response) {
                            switch (response.statusCode) {
                                case CODE.COMMON.SUCCESS:
                                    {
                                        arg.item.starred = 1;
                ...
                case 1:
                    {
                        ApiManagementResource.Star.Delete(template.request).$promise.then(function (response) {
                            switch (response.statusCode) {
                                case CODE.COMMON.SUCCESS:
                                    {
                                        arg.item.starred = 0;
                ...
                case 0:
                    {
                        $rootScope.EnsureModal($filter('translate')('012100230'), false, $filter('translate')('012100231'), {}, function (callback) {
                            if (callback) {
                                ApiManagementResource.Api.Delete(template.request).$promise.then(function (response) {
                                    switch (response.statusCode) {
                                        case CODE.COMMON.SUCCESS:
                                            {
                ...
                case 1:
                    {
                        $rootScope.EnsureModal($filter('translate')('012100234'), false, $filter('translate')('012100235'), {}, function (callback) {
                            if (callback) {
                                ApiManagementResource.Trash.Delete(template.request).$promise.then(function (response) {
                                    switch (response.statusCode) {
                                        case CODE.COMMON.SUCCESS:
                                            {
                                                vm.data.service.home.envObject.object.model.splice(arg.$index, 1);
        ...
        vm.data.fun.recover = function (arg) {
            ...
            $rootScope.ApiRecoverModal(template.modal, function (callback) {
                if (callback) {
                    template.request.groupID = callback.groupID;
                    ApiManagementResource.Trash.Recover(template.request).$promise.then(function (response) {
                        switch (response.statusCode) {
                            case CODE.COMMON.SUCCESS:
                                {
        ...
        vm.data.fun.clean = function () {
            ...
            $rootScope.EnsureModal($filter('translate')('012100240'), false, $filter('translate')('012100241'), {}, function (callback) {
                if (callback) {
                    ApiManagementResource.Trash.Clean(template.request).$promise.then(function (response) {
                        switch (response.statusCode) {
                            case CODE.COMMON.SUCCESS:
                                {
        ...
        vm.data.fun.batch.moveGroup = function () {
            ...
            $rootScope.ApiRecoverModal(template.modal, function (callback) {
                if (callback) {
                    template.request.groupID = callback.groupID;
                    ApiManagementResource.Api.Move(template.request).$promise.then(function (response) {
                        switch (response.statusCode) {
                            case CODE.COMMON.SUCCESS:
                                {
