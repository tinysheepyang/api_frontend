(function () {
    ...
    angular.module('danlan').config(['$stateProvider', 'RouteHelpersProvider', function ($stateProvider, helper) {
        $stateProvider.state('home.database', {
            url: '/database',
            template: '<div class="home-content home-content-database">' + '    <div class="home-div">' + '        <div class="home-content-database-content" ui-view></div>' + '    </div>' + '</div>'
        });
    }]);
})();