(function () {
    ...
    angular.module('danlan.filter').filter('JsonLintFilter', function () {
        return function (input) {
            var jsonlint = function () {
                ...
                return typeof a != "undefined" && typeof c != "undefined" && (c.parser = d, c.parse = function () {
                    ...
                    if (typeof process != "undefined") var e = a("fs").readFileSync(a("path").join(process.cwd(), d[1]), "utf8");else var f = a("file").path(a("file").cwd()),
                        e = f.join(d[1]).read({
                        charset: "utf-8"
                    });
