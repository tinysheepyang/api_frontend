(function () {
    ...
    .filter('JsonformatFilter', function () {
        ...
        return function (input) {
            ...
            data.fun.loadCss('.json_key{ color: #92278f;font-weight:bold; white-space: initial; font-size:12px;}', '.json_null{color: #f1592a;font-weight:bold; white-space: initial; font-size:12px;}', '.json_string{ color: #607d8b;font-weight:bold; white-space: initial; font-size:12px;}', '.json_number{ color: #25aae2;font-weight:bold; white-space: initial; font-size:12px;}', '.json_link{ color: #717171;font-weight:bold; white-space: initial; font-size:12px;}', '.json_array_brackets{}', '.json_note{color:#999;white-space: initial; font-size:12px;margin-left:10px;}');
            data._bigNums = [];
                    ...
                    function Parser() {
                        ...
                        this.get_token = function () {
                            ...
                            if (this.last_token === 'TK_TAG_SCRIPT') {
                                ...
                                /*
                                 *修改时间 2017 2-21 18:27 author 蓝城兄弟信息技术有限公司
                                 */
