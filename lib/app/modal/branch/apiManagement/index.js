(function () {
    ...
    angular.module('danlan.modal').directive('eoApiManagementModal', [function () {
        return {
            restrict: 'AE',
            templateUrl: 'app/modal/branch/apiManagement/index.html'
        };
    }]).controller('ApiManagement_AutoGenerationModalCtrl', ApiManagement_AutoGenerationModalCtrl).controller('ApiManagement_BackupsModalCtrl', ApiManagement_BackupsModalCtrl).controller('ApiManagement_AutomatedTest_QiuckAddSingalModalCtrl', ApiManagement_AutomatedTest_QiuckAddSingalModalCtrl).controller('ApiManagement_AutomatedTest_EditCaseModalCtrl', ApiManagement_AutomatedTest_EditCaseModalCtrl).controller('ApiManagement_AutomatedTest_BindModalCtrl', ApiManagement_AutomatedTest_BindModalCtrl);
