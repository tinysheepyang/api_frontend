(function () {
    ...
    angular.module('danlan.modal').directive('eoCommonModal', [function () {
        return {
            restrict: 'AE',
            templateUrl: 'app/modal/branch/common/index.html'
        };
    }]).controller('ExpressionBuilderModalCtrl', ExpressionBuilderModalCtrl).controller('InfoModalCtrl', InfoModalCtrl).controller('TipsModalCtrl', TipsModalCtrl).controller('MessageModalCtrl', MessageModalCtrl).controller('ImportModalCtrl', ImportModalCtrl).controller('ImportDatabaseModalCtrl', ImportDatabaseModalCtrl).controller('ExportModalCtrl', ExportModalCtrl).controller('ExportDatabaseModalCtrl', ExportDatabaseModalCtrl).controller('EnsureModalCtrl', EnsureModalCtrl).controller('JsonToParamInputModalCtrl', JsonToParamInputModalCtrl).controller('FieldModalCtrl', FieldModalCtrl).controller('ProjectModalCtrl', ProjectModalCtrl).controller('DatabaseModalCtrl', DatabaseModalCtrl).controller('GroupModalCtrl', GroupModalCtrl).controller('ApiRecoverModalCtrl', ApiRecoverModalCtrl).controller('TableModalCtrl', TableModalCtrl).controller('CodeModalCtrl', CodeModalCtrl).controller('RequestParamDetailModalCtrl', RequestParamDetailModalCtrl).controller('RequestParamEditModalCtrl', RequestParamEditModalCtrl).controller('ResponseParamDetailModalCtrl', ResponseParamDetailModalCtrl).controller('ResponseParamEditModalCtrl', ResponseParamEditModalCtrl).controller('UpdateModalCtrl', UpdateModalCtrl).controller('CommonSingleInputModalCtrl', CommonSingleInputModalCtrl).controller('Common_UploadFileCtrl', Common_UploadFileCtrl);
