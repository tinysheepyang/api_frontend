(function () {
    ...
    angular.module('danlan.modal', ['ui.bootstrap.modal']).directive('eoModal', [function () {
        return {
            restrict: 'AE',
            template: '<eo-common-modal></eo-common-modal>' + '<eo-api-management-modal></eo-api-management-modal>',
