(function () {
    ...
    //thrid part
    'ui.router', 'oc.lazyLoad', 'ngResource', 'angular-md5', 'pascalprecht.translate', 'ngCookies',
    //custom part
    'danlan.resource', 'danlan.modal', 'danlan.constant', 'danlan.filter', 'danlan.directive', 'danlan.service']).config(AppConfig).run(AppRun);
