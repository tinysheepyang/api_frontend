...
(function () {
    ...
    crop.factory('cropAreaSquare', ['cropArea', function (CropArea) {
        ...
        CropAreaSquare.prototype._calcSquareCorners = function () {
            var hSize = this._size / 2;
            return [[this._x - hSize, this._y - hSize / this.resSizeScale], [this._x + hSize, this._y - hSize / this.resSizeScale], [this._x - hSize, this._y + hSize / this.resSizeScale], [this._x + hSize, this._y + hSize / this.resSizeScale]];
        };
    ...
    crop.factory('cropArea', ['cropCanvas', function (CropCanvas) {
        ...
        CropArea.prototype._dontDragOutside = function () {
            ...
            if (this._y < this._size / 2 / this.resSizeScale) {
                this._y = this._size / 2 / this.resSizeScale;
            }
            if (this._y > (h - this._size / 2) / this.resSizeScale) {
                this._y = (h - this._size / 2) / this.resSizeScale;
            }
        };
