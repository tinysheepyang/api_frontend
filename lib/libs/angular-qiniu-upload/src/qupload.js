...
(function () {
    ...
    angularQFileUpload.service('$qupload', ['$http', '$q', 'localStorageService', function ($http, $q, localStorageService) {
...
angular.module('angularQFileUpload').directive('ngFileSelect', ['$parse', '$timeout', function ($parse, $timeout) {
