    ...
    var factory = function (exports) {
        ...
        exports.fn.linkDialog = function () {
            ...
            if (editor.find("." + dialogName).length > 0) {
                ...
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" + "<label>" + linkLang.url + "</label>" + "<input type=\"text\" value=\"http://\" data-url />" + "<br/>" + "<label>" + linkLang.urlTitle + "</label>" + "<input type=\"text\" value=\"" + selection + "\" data-title />" + "<br/>" + "</div>";
