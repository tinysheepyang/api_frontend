...
(function (mod) {
  ...
  TextareaInput.prototype = copyObj({
    ...
    poll: function () {
      ...
      if (text.charCodeAt(0) == 0x200b && cm.doc.sel == cm.display.selForContextMenu && !prevInput) prevInput = "\u200b";
    ...
    onContextMenu: function (e) {
      ...
      function rehide() {
        ...
        if (te.selectionStart != null) {
          ...
          var i = 0,
              poll = function () {
            if (display.selForContextMenu == cm.doc.sel && te.selectionStart == 0) operation(cm, commands.selectAll)(cm);else if (i++ < 10) display.detectingSelectAll = setTimeout(poll, 500);else display.input.reset();
          };
  ...
  function signalDOMEvent(cm, e, override) {
    if (typeof e == "string") e = { type: e, preventDefault: function () {
