...
(function (mod) {
    ...
    var tokenBase = function (stream, state) {
      ...
      if (stream.match(/[\w-]*/i)) {
        ...
        if (cssProperties[word] !== undefined) {
          // CSS property
          if (!stream.eol()) return "property";else return "variable-2";
  ...
  var wordOperators = ["in", "and", "or", "not", "is a", "is", "isnt", "defined", "if unless"],
      ...
      hintWords = wordOperators.concat(commonKeywords, commonAtoms, commonDef, cssTypeSelectors_, cssProperties_, cssValues_, cssValuesWithBrackets_, cssColorValues_);
